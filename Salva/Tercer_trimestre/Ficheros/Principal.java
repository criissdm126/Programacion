...
public class Principal {
 ...
 // MENÚ SOCIO
    ...
    private static void altaSocios() {
        ...
        System.out.println("Fecha de nacimiento del socio (dd/MM/yyyy):");
        String fnacimiento = sc.nextLine();
        System.out.println("Telefono del socio:");
        String tlf = sc.nextLine();
        System.out.println("Correo electronico del socio:");
        String correo = sc.nextLine();
        
     // Validar número de teléfono
        if (tlf.length() != 9) {
            System.out.println("El numero de telefono debe tener 9 dígitos. Socio no añadido.");
            return;
        }
        
        /*while(tlf.length() != 9){
         * System.out.println("El numero de telefono debe tener 9 dígitos. Vuelvelo a intentar: ");
         * tlf = sc.nextLine();
         * return;
         */
        // Validar correo electrónico
        if (!correo.endsWith("@gmail.com")) {
            System.out.println("El correo electronico debe terminar con @gmail.com. Socio no añadido.");
            return;
        }
        /*
         * while(!correo.endsWith("@gmail.com")){
         * System.out.println("El correo electronico debe terminar con @gmail.com. vuelvelo a añadir: ");
         * correo = sc.nextLine();
         * return;
         */
        ...
        // Añadir sc.nextline si o si, si no me devuelve al menú principal
        sc.nextLine();
