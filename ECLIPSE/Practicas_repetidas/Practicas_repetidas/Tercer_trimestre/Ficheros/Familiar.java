...
public class Familiar implements Serializable {
	...
	public Familiar(String d, String n, String f) {
		...
		ffnacimiento = LocalDate.parse(f, formato); // convertir una cadena de texto en formato de fecha
	}
	...
	public void setFfnacimiento(String ffnacimiento) {
		DateTimeFormatter f = DateTimeFormatter.ofPattern("dd/MM/yyyy"); // crea un objeto de la clase DateTimeFormatter que se utiliza para formatear y analizar fechas en un formato específico.
