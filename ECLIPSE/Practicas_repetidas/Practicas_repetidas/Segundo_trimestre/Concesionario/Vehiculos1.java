    ...
    public static Accesorio[] crearAccesorios(int menu) {
        ...
        switch (menu) {
            ...
            default:
                ...
                System.out.println("Opción inválida. Se crearán accesorios vacíos.");
    ...
    public static void mostrarCoches(Coche[] coches) {
        ...
        for (int i = 0; i < coches.length; i++) {
        	...
        	if (coches[i] != null) {
        		...
        		precioFinal = precioFinal + coches[i].getPrecioFinal();
                System.out.print(coches[i].toString());
                
                if (coches[i] instanceof CocheElectrico) {
                    System.out.print(" - Coche electrico");
                }
