    ...
    public static void main(String[] args) {
        ...
        public static void listarAlimentosPorTipo(ArrayList<Alimento> alimentos) {
            ...
            for (String tipoAlimento : tipos) {
                ...
                ArrayList<Alimento> alimentos_Tipo = new ArrayList<>();
                for (Alimento alimento : alimentos) {
                    if (alimento.getTipo().equals(tipoAlimento)) {
                        alimentos_Tipo.add(alimento);
                    }
                }
                //Ordenamos la lista
                Collections.sort(alimentos_Tipo);
                ...
                for (Alimento alimento : alimentos_Tipo) {
                ...
                double mediaCalorias = totalCalorias / alimentos_Tipo.size();
