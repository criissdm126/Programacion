...
public class palabras {
	...
	public static void main(String[] args) {
		...
		if ((uno.compareToIgnoreCase(dos) < 0) && 
				(dos.compareToIgnoreCase(tres) < 0)) {
				 System.out.println(uno + " > " + dos + " > " + tres);
				 }
				 else if ((uno.compareToIgnoreCase(tres) < 0) && 
				(tres.compareToIgnoreCase(dos) < 0)) {
				 System.out.println(uno + " > " + tres + " > " + dos);
				 }
				 else if ((dos.compareToIgnoreCase(uno) < 0) && 
				(uno.compareToIgnoreCase(tres) < 0)) {
				 System.out.println(dos + " > " + uno + " > " + tres);
				 }
				 else if ((dos.compareToIgnoreCase(tres) < 0) && 
				(tres.compareToIgnoreCase(uno) < 0)) {
				 System.out.println(dos + " > " + tres + " > " + uno);
				 }
				 
				 
				 else if ((tres.compareToIgnoreCase(uno) < 0) && 
				(uno.compareToIgnoreCase(dos) < 0)) {
				 System.out.println(tres + " > " +uno + " > " + dos);
				 }
				 else if ((tres.compareToIgnoreCase(dos) < 0) && 
				(dos.compareToIgnoreCase(uno) < 0)) {
				 System.out.println( tres + " > " + uno + " = " + dos);
				 }
