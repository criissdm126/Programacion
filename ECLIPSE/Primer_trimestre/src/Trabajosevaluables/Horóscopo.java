...
public class Horóscopo {
	...
	public static void main(String[] args) {
		...
		System.out.println("Dime tamben tu mes de nacimiento: ");
		double mes;
		mes = sc.nextDouble();
		...
		if(dia>=21 && dia<=31 && mes==3 || dia>=1 && dia<=19 && mes==4){
			...
			System.out.println("Tú signo del zodiaco es Géminis");
		}
		else if (dia>=21 && dia<=30 && mes==6 || dia>=1 && dia<=22 && mes==7) {
			System.out.println("Tú signo del zodiaco es Cáncer");
		}
