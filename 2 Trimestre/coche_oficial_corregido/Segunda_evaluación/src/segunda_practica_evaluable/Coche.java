  ...
  //MÉTODO VERPRECIO
   ...
   /* public void detenerse() {
	...
	public boolean equals(Object obj) {
		...
		return Arrays.equals(accesorios, other.accesorios) && acelerado == other.acelerado
				&& arrancado == other.arrancado && Objects.equals(cocheComb, other.cocheComb)
				&& Objects.equals(cocheElect, other.cocheElect) && frenado == other.frenado
	...
	public int hashCode() {
		...
		result = prime * result + Objects.hash(acelerado, arrancado, cocheComb, cocheElect, frenado, marca, modelo,
				precioBase, precioFinal, velocidad);
		return result;
	}
